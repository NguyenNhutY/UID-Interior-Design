      ...
      <div className="container py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5 flex justify-center flex-col xl:max-w-[500px] ">
            ...
            >
              A great project is built on collaboration, passion, and expertise. Our dedicated team works together to transform ideas into reality, ensuring every detail reflects excellence and innovation.
            </motion.p>
            <div>
              <motion.button
